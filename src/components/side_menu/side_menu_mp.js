    ...
    return(
      ...
      <div className="menu_container">
        <div className="container">
          <Link to='/my_page/dash_board'><div className="menu" id="smp_dash_board" onClick={() => { navigate() }}>
            대시보드
          </div></Link>
          <Link to='/my_page/current_event_state'><div className="menu" id="smp_event_state" onClick={() => { navigate() }}>
            이벤트 참가 현황
          </div></Link>
          <Link to='/my_page'><div className="menu" id="smp_my_info" onClick={() => { navigate() }}>
            내 정보
          </div></Link>
          <Link to='/my_page/wish_box'><div className="menu" id="smp_wish_box" onClick={() => { navigate() }}>
            소망 상자
          </div></Link>
          <div className="menu" id="smp_setting" onClick={() => { navigate() }}>
            설정
          </div>
        </div>
      </div>
